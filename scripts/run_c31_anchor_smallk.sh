...
case "${1:-help}" in
  ...
  *)
    echo "Usage: $0 {800|800_safe|1200|1200_safe|1200_odomselect|1200_smallkselect|1200_ignore_tiny_dt|1200_soft_tiny_dt|1200_dt_ramp|1200_smoothselect|1200_tmag_bias|1200_tmag_nodetach}"
