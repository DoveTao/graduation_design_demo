...
class Config:
    ...
    use_tmag_speed_loss: bool = False
    w_tmag_speed: float = 0.0
    tmag_speed_min_dt: float = 0.02
    use_tmag_ratio_loss: bool = False
    w_tmag_ratio: float = 0.0
    tmag_ratio_only_k: int = 1
    tmag_ratio_min_gt: float = 0.02
    use_tmag_chain_sum_loss: bool = False
    w_tmag_chain_sum: float = 0.0
    tmag_chain_sum_only_k: int = 1
    tmag_chain_sum_min_gt: float = 0.02
    use_traj_ate_loss: bool = False
    w_traj_ate: float = 0.0
    use_traj_drift_loss: bool = False
    w_traj_drift: float = 0.0
    use_traj_path_loss: bool = False
    w_traj_path: float = 0.0
    use_traj_rot_loss: bool = False
    w_traj_rot: float = 0.0
    use_traj_tdir_loss: bool = False
    w_traj_tdir: float = 0.0
    use_traj_tmag_step_loss: bool = False
    w_traj_tmag_step: float = 0.0
    use_traj_speed_loss: bool = False
    w_traj_speed: float = 0.0
    traj_window_only_k: int = 1
    traj_window_min_gt: float = 0.02
    traj_scale_normalize: bool = True
    traj_start_updates: int = 0
    traj_ramp_updates: int = 0
    use_tmag_regime_reweight: bool = False
    tmag_regime_pred_q: float = 0.90
    tmag_regime_gt_q: float = 0.90
    tmag_regime_weight_pred_high: float = 1.0
    tmag_regime_weight_gt_high: float = 1.0
    tmag_regime_weight_dt_ge_1: float = 1.0
    tmag_regime_weight_k20: float = 1.0
    ...
    train_tmag_head_only: bool = False
