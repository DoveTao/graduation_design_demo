# S5E15 comparison report

## 执行摘要
S5E15 用 train-prior scale + anti_parallel guard 尝试缓解 S5E14 的 under-scale，同时保持 traceable dense 与几何稳定性。
...
## 解释
- S5E15 重点验证 under-scale 缓解与 anti_parallel 风险是否同时改善。
- 即便有改善，S5E15 仍是 experimental candidate，不能替代 official S5。
