...
- Post-lockdown / post-S5 optimization attempts: `S8 = TOKEN-NO-ADDED-VALUE`, `S9 = NO-STABLE-REGIME-ROUTER-GAIN`, `S10 = NO-STABLE-CHAIN-SMOOTHER-GAIN`, `S11 = NO-STABLE-TMAG-CONSISTENCY-GAIN`
- Final message for thesis: S5 replaces S2b with a clean but marginal gain; later router, smoother, and training-time tmag-consistency optimization attempts did not yield a new clean deployable replacement.
