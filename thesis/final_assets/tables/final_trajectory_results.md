...
Table note: the refreshed `FINAL360M` trajectory backend does not surpass the old subset-model-based `ODOM360A`; backend fusion improves `FINAL360M-direct` but does not eliminate shape error.
