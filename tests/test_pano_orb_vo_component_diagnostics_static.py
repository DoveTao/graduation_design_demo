...
TOOL = REPO_ROOT / "tools" / "evaluate_pairwise_pose_components.py"
RUNNER = REPO_ROOT / "scripts" / "run_pano_orb_vo_component_diagnostics.sh"
REPORT = REPO_ROOT / "reports" / "pano_orb_vo_component_diagnostics.md"
RESULT_JSON = REPO_ROOT / "checkpoints" / "SB1b_pano_orb_vo_component_diagnostics.json"
MANIFEST = REPO_ROOT / "checkpoints" / "final_clean_candidate_manifest.json"


class PanoOrbVoComponentDiagnosticsStaticTest(unittest.TestCase):
    ...
    def test_report_content(self) -> None:
        ...
        self.assertIn("SB2b caveat", text)
